...
_This notebook uses **version 6** of Vega-Lite and the corresponding Vega-Lite API v6._ To see what's new in version 6, [have a look at the changelog](https://github.com/vega/vega-lite/releases/tag/v6.0.0). To use Vega-Lite version 5, see the [Vega-Lite API v5 notebook](https://observablehq.com/@vega/vega-lite-api-v5) instead. To use Vega-Lite version 4, see the [Vega-Lite API v4 notebook](https://observablehq.com/@vega/vega-lite-api) instead.
...
async function _vl(vegaVersion,vlVersion,apiVersion,tooltipVersion)
{
  const [vega, vegalite, api, tooltip] = await Promise.all([
    `https://cdn.jsdelivr.net/npm/vega@${vegaVersion}/+esm`,
    `https://cdn.jsdelivr.net/npm/vega-lite@${vlVersion}/+esm`,
    `https://cdn.jsdelivr.net/npm/vega-lite-api@${apiVersion}/+esm`,
    `https://cdn.jsdelivr.net/npm/vega-tooltip@${tooltipVersion}/+esm`
...
~~~ js
import {vl} from '@vega/vega-lite-api-v6'
~~~
...
function _standalone_use(md,vegaVersion,vlVersion,apiVersion,tooltipVersion){return(
md`<hr/>
...
<html lang="en">
  <head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/vega-lite@${vlVersion}"></script>
    <script src="https://cdn.jsdelivr.net/npm/vega-lite-api@${apiVersion}"></script>
    <script src="https://cdn.jsdelivr.net/npm/vega-tooltip@${tooltipVersion}"></script>
  </head>
  <body>
    <div id="view"></div>
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("vl")).define("vl", ["vegaVersion","vlVersion","apiVersion","tooltipVersion"], _vl);
  ...
  main.variable(observer("standalone_use")).define("standalone_use", ["md","vegaVersion","vlVersion","apiVersion","tooltipVersion"], _standalone_use);
  return main;
}
